	...
	$.fn.bart = function( method ) {
		...
		if(opts.sounds == true) {
			if((new Audio()).canPlayType('audio/mpeg') != "") {   // mp3 for IE
				snds.inflate = (new Audio('http://demo.naxits.com/mp3/inflate.mp3'));					snds.explode = (new Audio('http://demo.naxits.com/mp3/explode.mp3'));
				snds.cashin = (new Audio('http://demo.naxits.com/mp3/collect.mp3'));
				} else if((new Audio()).canPlayType('audio/x-wav')) { // wav for the rest
				snds.inflate = (new Audio('http://demo.naxits.com/mp3/inflate.wav'));					snds.explode = (new Audio('http://demo.naxits.com/mp3/explode.wav'));
				snds.cashin = (new Audio('http://demo.naxits.com/mp3/collect.wav'));
			}
		}
		...
		*/
		balloon.prototype.inflate = function(canvas) {
			...
			if(opts.sounds == true & this.pumps > 0) {
				if((new Audio()).canPlayType("audio/mpeg") != "") {   // mp3 for IE
					(new Audio('http://demo.naxits.com/mp3/inflate.mp3')).play();
					} else if((new Audio()).canPlayType("audio/x-wav")) { // wav for the rest
					(new Audio('http://demo.naxits.com/mp3/inflate.wav')).play();
				}
			}
